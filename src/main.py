    ...
    def process_current_frame(self):
        ...
        if results and results[0].boxes:
            for box in results[0].boxes:
                ...
                elif cls == 2 and confidence >= lie_down_conf_threshold:
                    # 睡觉检测：包括躺下和趴下
                ...
                # 也确保新人进来时能检测到手机使用
                if cls == 1 and confidence >= 0.5 and self.phone_detection_enabled and self.phone_autoencoder and self.skeleton_extractor:
                    # 生成唯一标识用于跟踪每个人
